...
DB::sql('CREATE TABLE Ticket (hash CHAR(12) PRIMARY KEY, title VARCHAR(40), description text, created date, owner CHAR(12), assigned CHAR(12), type int, state int, priority int, category CHAR(12), milestone CHAR(12));');
...
DB::sql('CREATE TABLE Project (hash VARCHAR(12), name VARCHAR(45), description TEXT, public int(1));');
