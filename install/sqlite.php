...
$this->get('DB')->sql('CREATE TABLE Ticket (hash CHAR(12) PRIMARY KEY, title VARCHAR(40), description text, created date, owner hash, assigned hash, type int, state int, priority int, category CHAR(12), milestone CHAR(12));');
...
$this->get('DB')->sql('CREATE TABLE Project (hash CHAR(12) PRIMARY KEY, name VARCHAR(40), description TEXT, public TINYINT(1));');
